...
public class DoctorAppointmentAdapter extends RecyclerView.Adapter<DoctorAppointmentAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup viewGroup, int i) {
        CardView cv = (CardView) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_appointment_doctor, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        doctorName.setText(appointmentList.get(i).getPatient());
