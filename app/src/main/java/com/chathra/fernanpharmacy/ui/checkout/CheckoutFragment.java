package com.chathra.fernanpharmacy.ui.checkout;
...
import com.chathra.fernanpharmacy.ui.bookAppointment.BookAppointmentFragmentDirections;
...
public class CheckoutFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        args = CheckoutFragmentArgs.fromBundle(getArguments());
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, jsonRequest, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        CheckoutFragmentDirections.ActionCheckoutFragmentToOrderSuccessFragment successFragment = CheckoutFragmentDirections.actionCheckoutFragmentToOrderSuccessFragment("<p>Order Reference No <b>#" + id + "</b></p>");
