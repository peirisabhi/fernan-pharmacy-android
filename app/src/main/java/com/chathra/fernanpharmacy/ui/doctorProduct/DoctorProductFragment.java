package com.chathra.fernanpharmacy.ui.doctorProduct;
...
import com.chathra.fernanpharmacy.databinding.FragmentDoctorProductBinding;
import com.chathra.fernanpharmacy.model.Product;
import com.chathra.fernanpharmacy.ui.product.ProductFragmentArgs;
import com.chathra.fernanpharmacy.ui.product.ProductFragmentDirections;
...
public class DoctorProductFragment extends Fragment {

    FragmentDoctorProductBinding binding;
    KProgressHUD hud;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDoctorProductBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DoctorProductFragmentDirections.ActionDoctorProductFragmentToDoctorCheckoutFragment checkoutFragment = DoctorProductFragmentDirections.actionDoctorProductFragmentToDoctorCheckoutFragment(product);
                Navigation.findNavController(binding.getRoot()).navigate(checkoutFragment);
            }
        });
